...
The `nomad/lotus-calibnet.nomad` file starts a single Lotus daemon task using the `raw_exec` driver. It mounts host volumes for the node repo and proof parameters and sets `LOTUS_PATH` to `/opt/lotus`.
